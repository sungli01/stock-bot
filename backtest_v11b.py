...
def run_backtest():
    print("=" * 60)
    print("Backtest v11: 거래량+가격 동시급등 매수 + BB돌파 트레일링 매도")
    print("=" * 60)
    ...
    if v5_summary:
        ...
        print(f"v11: ₩{capital:,.0f} ({final_return:+.1f}%) WR:{wr}%")
    ...
    # Save JSON
    json_path = '/home/ubuntu/.openclaw/workspace/stock-bot/backtest_v11b_result.json'
